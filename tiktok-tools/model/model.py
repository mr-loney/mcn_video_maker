...
import math
from .net import BaseConv, CSPLayer, DWConv, CSPDarknet
...
class MobileNetV3Small(nn.Module):
    def __init__(self, num_classes=2):
        ...
        backbone = mobilenetv3.mobilenet_v3_small(pretrained=False)
...
class YOLOPAFPN(nn.Module):
    """
    YOLOv3 weights. Darknet 53 is the default backbone of this weights.
    """
...
class YOLOX(nn.Module):
    """
    YOLOX weights module. The module list is defined by create_yolov3_modules function.
